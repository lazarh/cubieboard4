...
# Install kas via pipx (works on Debian/Ubuntu with externally-managed Python)
pipx install kas
# Make pipx-installed binaries available in PATH for the current session
export PATH="${PATH}:${HOME}/.local/bin"

echo "All host dependencies installed."
echo ""
echo "NOTE: If 'kas' is not found after opening a new shell, add this to ~/.bashrc:"
